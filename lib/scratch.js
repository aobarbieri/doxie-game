...
tailEl.classList.add('rotate90')
tailEl.classList.remove('rotate-90', 'rotate180')

tailEl.classList.add('rotate-90')
tailEl.classList.remove('rotate90', 'rotate180')

tailEl.classList.add('rotate180')
tailEl.classList.remove('rotate-90', 'rotate90')

tailEl.classList.remove('rotate-90', 'rotate180', 'rotate90')